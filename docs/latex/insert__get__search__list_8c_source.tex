...
\DoxyCodeLine{00033\ \}}
\DoxyCodeLine{00034\ }
\DoxyCodeLine{00035\ cell\_t\ *search\_data\_in\_list(list\_t\ *list,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *data)}
\DoxyCodeLine{00036\ \{}
...
\DoxyCodeLine{00042\ \ \ \textcolor{keywordflow}{while}\ (iter\ \&\&\ strcmp(iter-\/>data,\ data))}
